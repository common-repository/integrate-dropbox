...
class DropboxFile {
     ...
     * File Stream
     *
     * @var \CodeConfig\IntegrateDropbox\vendor\GuzzleHttp\Psr7\Stream
     */
    protected $stream;
    ...
    public static function createByStream( $fileName, $resource, $mode = self::MODE_READ ) {
        ...
        $stream = \CodeConfig\IntegrateDropbox\vendor\GuzzleHttp\Psr7\Utils::streamFor( $resource );
        if ( ! $stream ) {
     ...
     *
     * @return \CodeConfig\IntegrateDropbox\vendor\GuzzleHttp\Psr7\Stream
     * @throws \CodeConfig\IntegrateDropbox\SDK\Exceptions\DropboxClientException
     */
    ...
    public function open() {
        ...
        // Create a stream
        $this->stream = \CodeConfig\IntegrateDropbox\vendor\GuzzleHttp\Psr7\Utils::streamFor( fopen( $this->path, $this->mode ) );
    ...
    public function getMimetype() {
        return \CodeConfig\IntegrateDropbox\vendor\GuzzleHttp\Psr7\mimetype_from_filename( $this->path ) ?: 'text/plain';
    }
}
